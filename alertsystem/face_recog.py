...
def detect(img, cascade):
  ...
  rects = cascade.detectMultiScale(gray, scaleFactor=1.2, minNeighbors=4, minSize=(100, 100), flags = cv2.CASCADE_SCALE_IMAGE)
  #rects = cascade.detectMultiScale(gray,1.3,2,cv2.cv.CV_HAAR_DO_CANNY_PRUNING,(30,30))
...
if __name__ == "__main__":
  ...
  try:
    cv_image = resize_img(cv_image, 600)
  except:
    print 'loading error'
  else:
